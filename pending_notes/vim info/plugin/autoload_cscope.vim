...
augroup autoload_cscope
 ...
 au BufEnter *.hxx     call <SID>Cycle_csdb() | call <SID>Cycle_macros_menus()
 ...
 au BufUnload *.hxx    call <SID>Unload_csdb() | call <SID>Cycle_macros_menus()
 au BufUnload *.in[lc]	call <SID>Unload_csdb() | call <SID>Cycle_macros_menus()
augroup END
